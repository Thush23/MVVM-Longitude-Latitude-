package com.example.longlatimvvm;
...
import com.example.longlatimvvm.home.HomeViewModel;
import com.example.longlatimvvm.home.LonLatAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LonLatAdapter lonLatAdapter = new LonLatAdapter();
        recyclerView.setAdapter(lonLatAdapter);
        ...
        homeViewModel.getResponseLiveData().observe(this, new Observer<List<Response>>() {
            ...
            public void onChanged(@Nullable List<Response> responses) {
                lonLatAdapter.SetData(responses);
            }
        });
